...
export async function fillPdf(meta: Record<string, string>, data: Record<string, string>) {
  ...
  const fontManager = new FontManager(pdfDoc, {
    100: path.join(process.cwd(), 'fonts', 'NotoSans-Thin.ttf'),
    200: path.join(process.cwd(), 'fonts', 'NotoSans-ExtraLight.ttf'),
    300: path.join(process.cwd(), 'fonts', 'NotoSans-Light.ttf'),
    400: path.join(process.cwd(), 'fonts', 'NotoSans-Regular.ttf'),
    500: path.join(process.cwd(), 'fonts', 'NotoSans-Medium.ttf'),
    600: path.join(process.cwd(), 'fonts', 'NotoSans-SemiBold.ttf'),
    700: path.join(process.cwd(), 'fonts', 'NotoSans-Bold.ttf'),
    800: path.join(process.cwd(), 'fonts', 'NotoSans-ExtraBold.ttf'),
  });
